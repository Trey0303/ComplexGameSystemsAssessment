...
public class PlayerMovement : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        if (IsOwner)
        {
            GameObject myCam = Instantiate(cameraPrefab);
    ...
    void FixedUpdate()
    {
        ...
        {
            this.transform.position = Vector3.SmoothDamp(this.transform.position, networkPosition.Value, ref netVelocity, smoothTime);
            this.transform.rotation = networkRotation.Value;
    ...
    [ServerRpc(Delivery = RpcDelivery.Unreliable)]
    void OwnerSetRotationServerRpc(Quaternion newRotation)
    {
